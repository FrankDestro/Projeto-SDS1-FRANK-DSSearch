...
create table tb_record (id int8 generated by default as identity, age int4, moment TIMESTAMP WITHOUT TIME ZONE, name varchar(255), game_id int8, primary key (id));
